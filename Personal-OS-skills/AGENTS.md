...
- `self-review/` files are MECE — do not duplicate content across them. Each file owns its layer exclusively.
- `skills/` is the canonical skill location — do not put skill definitions in `.claude/skills/` directly.
