...
```bash
SKETCH_FILE=".gstack/tmp/gstack-sketch-$(date +%s).html"
```
...
$B screenshot .gstack/tmp/gstack-sketch.png
```
...
The screenshot file at `.gstack/tmp/gstack-sketch.png` can be referenced by downstream skills
