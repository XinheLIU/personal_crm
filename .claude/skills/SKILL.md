...
$B screenshot .gstack/tmp/after-login.png
```
...
$B screenshot .gstack/tmp/prod-check.png
```
...
$B snapshot -i -a -o .gstack/tmp/feature-annotated.png
...
$B goto https://yourapp.com
$B responsive .gstack/tmp/layout

# Manual: specific viewport
$B viewport 375x812     # iPhone
$B screenshot .gstack/tmp/mobile.png
$B viewport 1440x900    # Desktop
$B screenshot .gstack/tmp/desktop.png

# Element screenshot (crop to specific element)
$B screenshot "#hero-banner" .gstack/tmp/hero.png
$B snapshot -i
$B screenshot @e3 .gstack/tmp/button.png

# Region crop
$B screenshot --clip 0,0,800,600 .gstack/tmp/above-fold.png

# Viewport only (no scroll)
$B screenshot --viewport .gstack/tmp/viewport.png
```
...
$B screenshot .gstack/tmp/upload-result.png
```
...
$B snapshot -i
$B screenshot .gstack/tmp/github-profile.png
```
...
echo '[
  ...
  ["click","@e5"],
  ["snapshot","-D"],
  ["screenshot",".gstack/tmp/result.png"]
]' | $B chain
```
...
Example: `$B snapshot -i -a -C -o .gstack/tmp/annotated.png`
